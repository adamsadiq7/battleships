...
void insertIntBefore(list *l, int n);
void insertIntAfter(list *l, int n);
int getIntBefore(list *l);
int getIntAfter(list *l);
int setIntBefore(list *l, int n);
int setIntAfter(list *l, int n);
void deleteIntBefore(list *l);
void deleteIntAfter(list *l);

void insertBoolBefore(list *l, bool b);
void insertBoolAfter(list *l, bool b);
bool getBoolBefore(list *l);
bool getBoolAfter(list *l);
bool setBoolBefore(list *l, bool b);
bool setBoolAfter(list *l, bool b);
void deleteBoolBefore(list *l);
void deleteBoolAfter(list *l);

void insertCharBefore(list *l, char c);
void insertCharAfter(list *l, char c);
char getCharBefore(list *l);
char getCharAfter(list *l);
char setCharBefore(list *l, char c);
char setCharAfter(list *l, char c);
void deleteCharBefore(list *l);
void deleteCharAfter(list *l);

void insertStringBefore(list *l, char *s);
void insertStringAfter(list *l, char *s);
char *getStringBefore(list *l);
char *getStringAfter(list *l);
char *setStringBefore(list *l, char *s);
char *setStringAfter(list *l, char *s);
void deleteStringBefore(list *l);
void deleteStringAfter(list *l);
